export const FeatureCard = ({
    ...
    <div
        className="card bg-base-100/80 backdrop-blur-md shadow-lg border border-emerald-300/30 hover:shadow-emerald-400/40 hover:-translate-y-1 transition-all duration-300">
