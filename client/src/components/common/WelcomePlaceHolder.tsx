...
export const WelcomePlaceholder = ({ userName }: { userName: string }) => {
  return (
    <div className="text-center max-w-sm mx-auto bg-gray-800/80 rounded-2xl p-8 border border-emerald-500/30 shadow-md hover:shadow-emerald-400/50 transition-all duration-300">
      <img
        src={logo}
        alt="Studi.io Logo"
