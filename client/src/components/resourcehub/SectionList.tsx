    ...
    if (sections.length === 0) {
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div
                    className="text-center p-12 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border-2 border-dashed border-emerald-300 dark:border-emerald-700 max-w-md">
                    <div
                        className="mb-6 inline-flex p-4 bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900 dark:to-teal-900 rounded-full">
