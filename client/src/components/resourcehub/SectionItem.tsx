...
const SectionItem: React.FC<SectionItemProps> = ({
    ...
    return (
        <div
            className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-emerald-200 dark:border-emerald-800 overflow-hidden">
            {/* Section Header */}
            <div
