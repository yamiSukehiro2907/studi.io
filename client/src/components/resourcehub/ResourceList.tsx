...
const ResourceList: React.FC<ResourceListProps> = ({
    ...
    if (resources.length === 0) {
        return (
            <div
                className="flex flex-col items-center justify-center py-8 px-4 bg-gradient-to-br from-gray-50 to-emerald-50 dark:from-gray-900 dark:to-emerald-950 rounded-lg border-2 border-dashed border-emerald-300 dark:border-emerald-700">
