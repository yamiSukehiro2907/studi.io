...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-emerald-950 via-slate-900 to-teal-950 text-white">
      {/* Hero Section */}
      <section className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 px-6 py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-72 h-72 bg-emerald-500/10 rounded-full blur-3xl -z-10 animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-teal-500/10 rounded-full blur-3xl -z-10 animate-pulse delay-200"></div>
      ...
      <section className="py-24 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-emerald-900/0 via-emerald-900/10 to-teal-900/0 -z-10"></div>
        <div className="container mx-auto px-6 text-center">
          <span className="text-emerald-400 font-semibold uppercase tracking-wider">
            Get Started Fast
          </span>
      ...
      {/* Final CTA Section */}
      <section className="bg-gradient-to-br from-emerald-500/10 via-emerald-900/10 to-teal-500/10 py-24 border-t border-emerald-500/10">
        <div className="container mx-auto px-6 text-center">
      ...
      {/* Footer */}
      <footer className="py-8 text-center text-sm text-gray-400 border-t border-emerald-500/20 flex flex-col items-center gap-3">
        <p>
