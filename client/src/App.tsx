...
const AppLayout = () => {
    ...
    return (
        ...
        >
            <header
                className="navbar bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-emerald-500/10 backdrop-blur-md shadow-md sticky top-0 z-50 px-4 lg:px-8 border-b border-emerald-200/20">
...
function App() {
    ...
    return (
        <Routes>
            ...
            {/* Verify email route - accessible when logged in but not verified */}
